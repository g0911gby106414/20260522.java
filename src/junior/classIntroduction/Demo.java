...
public class Demo {
    public static void main(String[] args) {
        ...
        int r = 5;
        AreaPlus areaPlus1 = new AreaPlus(r); // 圓形
        areaPlus1.getArea();

        AreaPlus areaPlus2 = new AreaPlus(r, 3); // 長方形
        areaPlus2.getArea();

        AreaPlus areaPlus3 = new AreaPlus(r, 3, true); // 三角形
        areaPlus3.getArea();

        AreaPlus areaPlus4 = new AreaPlus(r, 7, 3); // 梯形
        areaPlus4.getArea();
