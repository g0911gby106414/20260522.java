package basic;
//變數的基本類別
//快速輸出(印出):      sout +teb => System.out.println();
...
public class BasicDeclare {
    public static void main(String[] args) throws Exception{
        ...
        // char: 字元, 1個字元, 單引號, fn鍵+雙引號=>''
        char c1 = 'Y';
        System.out.println("字元(char): " + c1);

        // String: 字串, 多個字元, 雙引號 shift鍵+"",型別宣告是大寫S
        String name = "文字Edward";
        ...
        System.out.println("陣列(String)-xx3: " + xx3[0]);
        System.out.println("陣列(String)-xx3: " + xx3[1]);
        System.out.println("陣列(String)-xx3: " + xx3[2]);
